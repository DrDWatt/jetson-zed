...
# Configuration
VIDEO_OUTPUT_DIR = "/home/nvidia/jetson-zed/videos"
CONTROL_FILE = "/home/nvidia/jetson-zed/videos/.control"
STATUS_FILE = "/home/nvidia/jetson-zed/videos/.status"
ANALYSIS_FILE = "/home/nvidia/jetson-zed/videos/.analysis"
...
class CaptureService:
    ...
    def logCameraInfo(self):
        ...
        s = self.settings
        print("ZED SDK initialized: {}".format(info.camera_model))
    ...
    def recordingLoop(self, filename):
        ...
        if os.path.exists(outputPath) and outputPath.endswith('.svo'):
    ...
    def analyzeScene(self):
        ...
        # Compute recommended exposure/gain
        ...
        # Build verdict
        if avgBrightness < TARGET_BRIGHTNESS_LOW:
            verdict = "TOO_DARK"
            verdictText = "Scene is too dark (avg {:.0f}/255)".format(avgBrightness)
        elif avgBrightness > TARGET_BRIGHTNESS_HIGH:
            verdict = "TOO_BRIGHT"
    ...
    def computeRecommendedSettings(self, avgBrightness, avgR, avgG, avgB,
        ...
        if avgBrightness < TARGET_BRIGHTNESS_LOW:
            ...
            ratio = TARGET_BRIGHTNESS_IDEAL / max(avgBrightness, 1)
            ...
            elif avgBrightness < TARGET_BRIGHTNESS_LOW:
    ...
    def spawnPreviewConversion(self, svoPath):
        ...
        if os.path.exists(script) and svoPath.endswith('.svo'):
