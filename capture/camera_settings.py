...
SETTINGS_FILE = "/home/nvidia/jetson-zed/videos/.settings"
...
# SDK exposure 0-100 maps linearly to 0-33333μs at 30fps
def exposureToShutterSpeed(exposureValue, fps=30):
    ...
    if shutterFraction >= 1:
        return "1/{:.0f}s ({:.0f}μs)".format(shutterFraction, exposureUs)
    return "{:.0f}μs".format(exposureUs)
